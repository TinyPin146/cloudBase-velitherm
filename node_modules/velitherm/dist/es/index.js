 ...
 */
export var velitherm = 'velitherm';
/**
 ...
 * @returns {number}
 */
export function altitudeFromStandardPressure(pressure, pressure0) {
    if (pressure0 === void 0) { pressure0 = P0; }
    pressure0 = pressure0 !== null && pressure0 !== void 0 ? pressure0 : P0;
 ...
 * @returns {number}
 */
export function pressureFromStandardAltitude(height, pressure0) {
    if (pressure0 === void 0) { pressure0 = P0; }
    pressure0 = pressure0 !== null && pressure0 !== void 0 ? pressure0 : P0;
 ...
 * @returns {number}
 */
export function altitudeFromPressure(pressure, pressure0, temp) {
    if (pressure0 === void 0) { pressure0 = P0; }
    if (temp === void 0) { temp = T0; }
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export function pressureFromAltitude(height, pressure0, temp) {
    if (pressure0 === void 0) { pressure0 = P0; }
    if (temp === void 0) { temp = T0; }
    pressure0 = pressure0 !== null && pressure0 !== void 0 ? pressure0 : P0;
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export function waterVaporSaturationPressure(temp) {
    if (temp === void 0) { temp = T0; }
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export function relativeHumidity(specificHumidity, pressure, temp) {
    if (pressure === void 0) { pressure = P0; }
    if (temp === void 0) { temp = T0; }
    pressure = pressure !== null && pressure !== void 0 ? pressure : P0;
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export function dewPoint(relativeHumidity, temp) {
    if (temp === void 0) { temp = T0; }
    temp = temp !== null && temp !== void 0 ? temp : T0;
    var b = 17.62;
    var c = 243.12;
 ...
 * @returns {number}
 */
export function relativeHumidityFromDewPoint(dewPoint, temp) {
    if (temp === void 0) { temp = T0; }
    temp = temp !== null && temp !== void 0 ? temp : T0;
    var b = 17.62;
    var c = 243.12;
 ...
 * @returns {number}
 */
export var mixingRatio = function (specificHumidity) { return specificHumidity / (1 - specificHumidity / 1000); };
/**
 ...
 * @returns {number}
 */
export var specificHumidityFromMixingRatio = function (mixingRatio) { return mixingRatio / (1 + mixingRatio / 1000); };
/**
 ...
 * @returns {number}
 */
export function specificHumidity(relativeHumidity, pressure, temp) {
    if (pressure === void 0) { pressure = P0; }
    if (temp === void 0) { temp = T0; }
    pressure = pressure !== null && pressure !== void 0 ? pressure : P0;
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export function airDensity(relativeHumidity, pressure, temp) {
    if (pressure === void 0) { pressure = P0; }
    if (temp === void 0) { temp = T0; }
    pressure = pressure !== null && pressure !== void 0 ? pressure : P0;
    temp = temp !== null && temp !== void 0 ? temp : T0;
 ...
 * @returns {number}
 */
export var LCL = function (temp, dewPoint) { return 126.7 * (temp - dewPoint); };
/**
 ...
 * @returns {number}
 */
export function gammaMoist(temp, pressure) {
    if (pressure === void 0) { pressure = P0; }
    pressure = pressure !== null && pressure !== void 0 ? pressure : P0;
    var tK = temp + 273.15;
