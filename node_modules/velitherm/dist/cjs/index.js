...
exports.gammaMoist = exports.LCL = exports.airDensity = exports.specificHumidity = exports.specificHumidityFromMixingRatio = exports.mixingRatio = exports.relativeHumidityFromDewPoint = exports.dewPoint = exports.relativeHumidity = exports.waterVaporSaturationPressure = exports.pressureFromAltitude = exports.altitudeFromPressure = exports.pressureFromStandardAltitude = exports.altitudeFromStandardPressure = exports.R = exports.Mv = exports.Md = exports.Rv = exports.Rd = exports.T0 = exports.P0 = exports.gamma = exports.L = exports.Cp = exports.G = exports.velitherm = void 0;
/**
...
function altitudeFromStandardPressure(pressure, pressure0) {
    if (pressure0 === void 0) { pressure0 = exports.P0; }
    pressure0 = pressure0 !== null && pressure0 !== void 0 ? pressure0 : exports.P0;
    return 44330.0 * (1.0 - Math.pow(pressure / pressure0, 1 / 5.255));
}
exports.altitudeFromStandardPressure = altitudeFromStandardPressure;
/**
...
exports.pressureFromStandardAltitude = pressureFromStandardAltitude;
/**
...
function altitudeFromPressure(pressure, pressure0, temp) {
    if (pressure0 === void 0) { pressure0 = exports.P0; }
    if (temp === void 0) { temp = exports.T0; }
    temp = temp !== null && temp !== void 0 ? temp : exports.T0;
    return Math.round((Math.pow(pressure0 / pressure, 1.0 / 5.257) - 1) * (temp + 273.15) / 0.0065);
}
exports.altitudeFromPressure = altitudeFromPressure;
/**
...
exports.pressureFromAltitude = pressureFromAltitude;
/**
...
exports.waterVaporSaturationPressure = waterVaporSaturationPressure;
/**
...
function relativeHumidity(specificHumidity, pressure, temp) {
    if (pressure === void 0) { pressure = exports.P0; }
    if (temp === void 0) { temp = exports.T0; }
    pressure = pressure !== null && pressure !== void 0 ? pressure : exports.P0;
    temp = temp !== null && temp !== void 0 ? temp : exports.T0;
...
function dewPoint(relativeHumidity, temp) {
    ...
    var b = 17.62;
    var c = 243.12;
    var gamma = Math.log(relativeHumidity / 100) + b * temp / (c + temp);
...
function relativeHumidityFromDewPoint(dewPoint, temp) {
    ...
    var b = 17.62;
    var c = 243.12;
    var gamma = dewPoint * b / (dewPoint + c);
    return Math.exp(gamma - b * temp / (c + temp)) * 100;
}
exports.relativeHumidityFromDewPoint = relativeHumidityFromDewPoint;
/**
 ...
 * @returns {number}
 */
var mixingRatio = function (specificHumidity) { return specificHumidity / (1 - specificHumidity / 1000); };
exports.mixingRatio = mixingRatio;
/**
 ...
 * @returns {number}
 */
var specificHumidityFromMixingRatio = function (mixingRatio) { return mixingRatio / (1 + mixingRatio / 1000); };
exports.specificHumidityFromMixingRatio = specificHumidityFromMixingRatio;
/**
...
exports.specificHumidity = specificHumidity;
/**
 * Air density.
 *
 * @param {number} relativeHumidity Relative humidity
...
function airDensity(relativeHumidity, pressure, temp) {
    ...
    var Pd = pressure - Pv;
    return 100 * (Pd * exports.Md + Pv * exports.Mv) / (exports.R * (temp + 273.15));
}
 ...
 * @returns {number}
 */
var LCL = function (temp, dewPoint) { return 126.7 * (temp - dewPoint); };
exports.LCL = LCL;
/**
...
function gammaMoist(temp, pressure) {
    ...
    pressure = pressure !== null && pressure !== void 0 ? pressure : exports.P0;
    var tK = temp + 273.15;
    var es = 6.113 * Math.exp(5423 * (1 / 273.15 - 1 / tK));
    var rs = 0.622 * es / (pressure - es);
    var gamma = 9.8e-3 * (1 + 8711 * rs / tK) / (1 + 1.35e7 * rs / (tK * tK));
    return gamma;
}
exports.gammaMoist = gammaMoist;
